    ...
    <section className="bg-[#f5f3ef] py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10">
          {dataPriceTiers.map((tier, idx) => {
            return (
              <div key={tier.id} className="w-full">
                <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-100 h-full flex flex-col justify-between transition-shadow duration-300 hover:shadow-xl">
